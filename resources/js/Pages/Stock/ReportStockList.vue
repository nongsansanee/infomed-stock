<template>
    <AppLayout>
		...
		<tbody class="block md:table-row-group">
			<tr v-for="(report_stock_list) in $page.props.report_stock_lists" :key=report_stock_list.id
				...
				<td class="text-left  block md:table-cell md:border md:border-gray-400"><span class="inline-block w-1/3 md:hidden font-bold">เดือน</span>{{months[report_stock_list.month].name}}</td>
